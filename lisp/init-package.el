;;; init-package.el --- initalize package management
...
;; I was getting the following error when listing packages: "error in process
;; sentinel: Error retrieving: https://elpa.gnu.org/packages/archive-contents
